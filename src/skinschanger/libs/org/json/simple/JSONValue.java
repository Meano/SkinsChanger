...
public class JSONValue {
	 ...
	 * <p>
	 * DO NOT call this method from toJSONString() of a class that
	 * implements both JSONAware and Map or List with "this" as the
	 * parameter, use JSONObject.toJSONString(Map) or
